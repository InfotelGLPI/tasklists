...
class Task_Comment extends CommonDBTM
{
     ...
     * @return array
     */
    public static function getCommentsForTaskItem($plugin_tasklists_tasks_id, $lang, $parent = null)
    {
        global $DB;
     ...
     * @return array
     */
    private static function buildCommentsTree($comments)
    {
        $tree = [];
     ...
     * @return string
     */
    public static function getCommentForm($plugin_tasklists_tasks_id, $lang = null, $edit = false, $answer = false)
    {
        $content = '';
        if ($edit !== false) {
