...
xgettext *.php */*.php --copyright-holder='Tasklists Development Team' --package-name='GLPI - Tasklists plugin' --package-version='1.2.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
