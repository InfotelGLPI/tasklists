    ...
    $.fn.kanban = function (options) {
        ...
        function build_items() {
            ...
            settings.items.forEach(function (item, index, array) {
                ...
                append += '<div class="' + classes.kanban_board_item_title_class + '">' + '<div id="dialog"></div><a id="showdialog' + item.id + '" href="#">' + item.title + '</a>' + '</div>';//../ajax/seetask.php?id=' + item.id + '
                ...
                $(function() {
                    ...
                    $("a#showdialog" + item.id).click(function(){
                        ...
                        // $("#dialog").append("../ajax/seetask.php?id=" + item.id);
