(function ($) {
    ...
    $.fn.kanban = function (options) {
        ...
        function build_kanban() {
            ...
            var action = '';
            action +='<div class="filterleft">';
            if (settings.allright == 1) {
                action += '<div class="filter"><a id="seemytasks" href="#">';
                if (settings.seemytasks == 1) {
                    action += '<span>' + settings.lang['see_all_tasks'] + '</span>';
                } else {
                    action += '<span>' + settings.lang['see_my_tasks'] + '</span>';
                }
                action += '</a></div>';
            }
            ...
            $(function () {
                $("a#seemytasks").click(function () {
                    $.ajax({
                        data: settings.seemytasks,
                        type: 'POST',
                        url: '../ajax/seemytasks.php',
                        success: function (data) {
                            build_items(settings.seemytasks,settings.seearchivedtasks, true);
                        }
                    });
                });
            ...
            build_items(settings.seemytasks,settings.seearchivedtasks, false);
        }
        ...
        function build_items(seemytasks,seearchivedtasks, reload) {
            ...
            settings.items.forEach(function (item, index, array) {
                ...
                if (reload == 1) {
                    ...
                    if ((seemytasks == 1 && item.users_id == settings.users_id) || seemytasks == 0) {
