    ...
    $.fn.kanban = function (options) {
        ...
        function build_items() {
            ...
            settings.items.forEach(function (item, index, array) {
                ...
                append += '<div class="' + classes.kanban_board_item_title_class + '"><span style=background-color:'
                        + item.bgcolor + ' class="dot" title="'+ item.priority +'"></span>&nbsp;' + //
                ...
                if (item.footer) {
                    append += '<div class="' + classes.kanban_board_item_footer_class + '">' +
                        ...
                        '<div align="right"><input type="text" id="percent' + item.id + '" readonly style="border:0; color:#CCC; font-weight:bold;" size="3"></div>'+
