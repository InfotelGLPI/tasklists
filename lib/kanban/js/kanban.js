    ...
    $.fn.kanban = function (options) {
        ...
        function build_titles() {
            ...
            settings.titles.forEach(function (item, index, array) {
                var title = '<div id="adddialog"></div><div id="title' + item.id + '" style="background: ' + settings.colours[item.id] + '" class="'
                    + classes.kanban_board_title_class + '"><p><a id="showadddialog'
                    + item.id + '" href="#"><i class="fa fa-plus-circle fa-white"></i></a>&nbsp;'
                    + item.title + '&nbsp;(' + item.count + ')</p>' + '</div>';
        ...
        function build_items() {
            ...
            settings.items.forEach(function (item, index, array) {
                ...
                var append = '<div id="div' + item.id + '" class="' + classes.kanban_board_item_class + '" data-id="' + item.id + '" style="background: ' + item.bgcolor + '">';
                append += '<div class="' + classes.kanban_board_item_title_class + '">' +
                    '<a id="updatepriority' + item.id + '" href="#"><i class="fa fa-arrow-up"></i></a>&nbsp;' +
                    '<div id="dialog"></div><a id="showdialog' + item.id + '" href="#">' + item.title + '</a>' +
                    '</div><div id="hideopt' + item.id + '" class="hideopt"><i id="hide' + item.id + '" class="fa faopt' + item.id + ' fa-caret-up"></i></div><div class="panelopt' + item.id + '" '+ item.finished + '>';
                ...
                if (item.footer) {
                    append += '<div class="' + classes.kanban_board_item_footer_class + '">' +
                        ...
                        item.footer + '</div><div align="right" class="endfooter">' + item.actiontime+ '</div>';
