    ...
    $.fn.kanban = function (options) {
        ...
        function build_items() {
            ...
            settings.items.forEach(function (item, index, array) {
                ...
                append += '<div id="dialog"></div><a id="showdialog' + item.id + '" href="#">' + item.title + '</a>'
                    + '</div>' + item.footer + '</div><div id="hideopt' + item.id + '" class="hideopt"><i id="hide'
                    + item.id + '" class="fa faopt' + item.id + ' ' + faimg + '" title="' + settings.lang['see_details']
                    + '"></i></div><div class="panelopt' + item.id + '" ' + item.finished_style + '>';
