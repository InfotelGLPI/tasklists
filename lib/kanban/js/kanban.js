        ...
        function build_items() {
            ...
            settings.items.forEach(function (item, index, array) {
                ...
                append += '<div class="title"><div class="' + classes.kanban_board_item_title_class + '">' +
                    '<a id="updatepriority' + item.id + '" href="#" title="Update priority"><i class="fa fa-arrow-up"></i></a>&nbsp;' +
                    '<div id="dialog"></div><a id="showdialog' + item.id + '" href="#">' + item.title + '</a>' +
                    '</div>' + item.footer +'</div><div id="hideopt' + item.id + '" class="hideopt"><i id="hide' + item.id + '" class="fa faopt' + item.id + ' fa-caret-up"></i></div><div class="panelopt' + item.id + '" '+ item.finished + '>';
