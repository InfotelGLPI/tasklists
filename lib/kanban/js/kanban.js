...
//INFOTEL
      this.tasklist_root = CFG_GLPI.root_doc + "/plugins/tasklists/ajax/";
      /**
      ...
      **/
      ...
      const buildToolbar = function() {
         ...
         var users = $("<div id='opt-users'></div>").appendTo(toolbar);
         if (self.rights.canModifyView()) {
      ...
      const registerEventListeners = function() {
         ...
         //Infotel
         var switchuser = $("select[name='usersKanban[]']").first();
         $('#opt-users').on('change', switchuser, function (e) {
